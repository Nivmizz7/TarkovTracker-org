...
const availablePermissions: Permissions = {
  GP: {
    ...
    description:
      `Allows access to read your progression information, including your TarkovTracker display \
...
PvE, or Dual).`,
  ...
  TP: {
    ...
    description:
      `Allows access to read a virtual copy of your team's progress, including display names, quest, \
